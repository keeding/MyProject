...
public class Function implements java.io.Serializable {
	...
	private String page;
	private String generatemenu="1";//1生成，0不生成
	...
	public String toString() {
		return "Function [id=" + id + ", function=" + function + ", name=" + name + ", code=" + code + ", description="
				+ description + ", page=" + page + ", generatemenu=" + generatemenu + ", zindex=" + zindex
				+ ", functions=" + functions + ", roles=" + roles + "]";
	}
