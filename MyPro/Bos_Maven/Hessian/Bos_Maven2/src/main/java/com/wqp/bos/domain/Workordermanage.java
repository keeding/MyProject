...
public class Workordermanage implements java.io.Serializable {
	...
	private String managerCheck = "0";//是否审核 0未审核、1已审核
	private String start = "0";//是否启动 0未审核、1已审核
	...
	public String toString() {
		return "工作单信息[编号="+id+",货物名称="+product+",货物重量="+weight+",收货人"+receivername+",收货人电话"+receiverphone+"]";
	}
