...
// 			url : "json/subarea.json",
	...
	function showCharts(){
		...
		$.post('${pageContext.request.contextPath }/subareaAction_showCharts.action',function(data){
			$("#showCharts").highcharts({
		        title: {
		            text: '分区各区域占比'
		        },
		        series: [{
...
<body class="easyui-layout" style="visibility:hidden;">
	...
	<div class="easyui-window" title="分区添加修改" id="addSubareaWindow" collapsible="false" minimizable="false" maximizable="false" style="top:20px;left:200px">
		...
		<div style="overflow:auto;padding:5px;" border="false">
			<form action="${pageContext.request.contextPath }/subareaAction_save.action">
	...
	<!-- 添加 修改分区 -->
	<div class="easyui-window" title="分区添加修改" id="showChartsWindow" collapsible="false" minimizable="false" maximizable="false" style="top:20px;left:200px">
		<div id="showCharts" split="false" border="false" >
		</div>
	</div>
</body>
</html>