...
public class JedisTest {
	...
	public void testJedisCluster() throws Exception {
		...
		nodes.add(new HostAndPort("192.168.56.102", 7003));
		nodes.add(new HostAndPort("192.168.56.102", 7004));
		nodes.add(new HostAndPort("192.168.56.102", 7005));
		nodes.add(new HostAndPort("192.168.56.102", 7006));
